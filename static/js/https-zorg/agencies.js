$(document).ready(function () {
  ...
  $.get("/data-zorg/agencies/https.json", function(data) {
  ...
  var renderTable = function(data) {
    var table = $("table").DataTable({
      ...
      "oLanguage": {
        ...
        "sInfo": "_START_ tot _END_ van _TOTAL_ zorginstellingen",
        "sInfoEmpty": "Geen zorginstellingen beschikbaar",
        "sInfoThousands": ".",
        "sLengthMenu": 'Toon _MENU_ zorginstellingen',
        "sSearch": "Zoeken:"
      },
